...
@InputType()
class FeedbackCreateNestedManyWithoutCandidatesInput {
...
export { FeedbackCreateNestedManyWithoutCandidatesInput as FeedbackCreateNestedManyWithoutCandidatesInput };
